  ...
  <div class="details container">
    <h1 class="page-header">
      ...
      <span class="pull-right">
        <router-link class="btn btn-primary" :to="'/edit/'+ customer.id"></router-link>
...
export default {
  ...
  methods: {
    fetchCustomer(id) {
      this.$http
        .get(
          "http://localhost/slim/slimapp/public/index.php/api/customer/" + id
        )
    ...
    deleteCustomer(id) {
      this.$http
        .delete(
          "http://localhost/slim/slimapp/public/index.php/api/customer/delete/" +
            id
        )
        .then(function(response) {
          this.$router.push({
